...
I am familiar with the programming languages C++ and Python. I primarily use VS Code to write and modify code. I have some experience with Docker and Postman. I want to further develop my general programming skills in my preferred programming languages. In particular, I want to get better at analyzing codebases that span multiple files.